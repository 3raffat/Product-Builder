...
export const productList: IProduct[] = [
  {
    ...
    title: "Nike Shoes",
    description:
      "As luxury T-Shirt is just as distinctive and can be trimmed with premium materials like Nappa leather and carbon fiber Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio nemo eumvoluptas! Sint dolores maiores eius suscipit, tempora vero molestias",
    imageURL:
